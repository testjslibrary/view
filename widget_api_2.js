...
k.v=function(){var a=U(this.b,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!=window.top&&document.referrer);return a};k.I=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(t(a))for(var c in a)this.j[c]=a[c];break;case "infoDelivery":jb(this,a);break;case "initialDelivery":window.clearInterval(this.f);this.l={};this.j={};kb(this,a.apiInterface);jb(this,a);break;default:this.s(b,a)}};
